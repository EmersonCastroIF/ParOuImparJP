//Incluido Váriavel Jogada para acompanhar o número de jogadas realizadas.
...
class MainActivity : AppCompatActivity() {
    ...
    var resultado = 0
    private var score = 0
    private var jogada = 0 // variável adicional
    ...
    fun jogada(view: View) {
        ...
        title = "Score do jogo: $score | Jogadas feitas: $jogada" 
